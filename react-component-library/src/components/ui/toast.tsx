  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-xl border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        success: "border-green-500/50 bg-green-50/95 dark:bg-green-950/95 backdrop-blur-sm text-green-900 dark:text-green-100",
        error: "border-red-500/50 bg-red-50/95 dark:bg-red-950/95 backdrop-blur-sm text-red-900 dark:text-red-100",
        warning: "border-yellow-500/50 bg-yellow-50/95 dark:bg-yellow-950/95 backdrop-blur-sm text-yellow-900 dark:text-yellow-100",
        info: "border-blue-500/50 bg-blue-50/95 dark:bg-blue-950/95 backdrop-blur-sm text-blue-900 dark:text-blue-100",
        loading: "border-primary/50 bg-primary/5 backdrop-blur-sm text-foreground",
        premium: "border-purple-500/50 bg-gradient-to-r from-purple-50/95 to-pink-50/95 dark:from-purple-950/95 dark:to-pink-950/95 backdrop-blur-sm text-purple-900 dark:text-purple-100",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ 
  ...
  // Auto-determine variant based on props
  let toastVariant = variant
  if (loading) toastVariant = "loading"
