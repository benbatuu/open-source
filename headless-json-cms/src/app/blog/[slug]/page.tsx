...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  try {
    ...
    const post = posts.find((p: ContentItem) => p.slug === slug && p.status === "published")
    ...
    const canonicalUrl = post.metadata?.["canonical-url"] || `${settings.general.siteUrl}/blog/${slug}`
              ...
              <header className="mb-12">
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.metadata?.["seo-title"] || post.title)}&url=${encodeURIComponent(`${settings.general.siteUrl}/blog/${slug}`)}`}
                      target="_blank"
                    ...
                    <a
                      href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`${settings.general.siteUrl}/blog/${slug}`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="h-8 w-8 p-0 inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground"
                    >
                    ...
                    <a
                      href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`${settings.general.siteUrl}/blog/${slug}`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="h-8 w-8 p-0 inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground"
                    >
